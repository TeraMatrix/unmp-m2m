...
pagehandlers.update({
    ...
    # Utils
    "get_service_parameters": inventory_controller.get_service_parameters,
    "host_service_parameter_graph": inventory_controller.host_service_parameter_graph,
    "update_form_host_service_parameter": inventory_controller.update_form_host_service_parameter,
    "update_host_service_parameter": inventory_controller.update_host_service_parameter,
    "relay_action": inventory_controller.relay_action,
})
