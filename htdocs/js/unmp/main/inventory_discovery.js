...
var messages = {
    ...
    "del": "Selected Device(s) deleted successfully",
    "delConfirm": "Are you sure want to delete the selected Device(s)?",
    "duplicateError": "Please enter a different Device Name, Device Alias, IP  and MAC",
    "noneSelectedError": "Please select atleast one Device",
    "multiSelectedError": "Please select a single Device.",
    ...
    "ping_start": "PING Discovery started successfully, You will get discovered Device within 60 secs.",
    ...
    "snmp_start": "SNMP Discovery started successfully, You will get discovered Device within 60 secs.",
    ...
    "upnp_start": "UPNP Discovery start successfully, You will get discovered Device within 60 secs.",
    ...
    "licenseError": "Maximum number of allowed Device have reached. To Complete this action you need to upgrade your license please contact sales team.",
    ...
    "ccuDhcpNetmaskError": "DHCP netmask required for CCU type Device",
...
function run_ping(discovery_id) {
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.success == 0) {
                $().toastmessage('showSuccessToast', "Devices Discovered Successfully");
                $("a#discovered_host_tab").click();
            }
            else {
                $().toastmessage('showErrorToast', messages[result.msg]);
