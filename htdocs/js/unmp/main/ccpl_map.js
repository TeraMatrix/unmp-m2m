        ...
        ccplMap: function (settings) {
            settings = jQuery.extend({
                ...
                onNMSClick: function (id) {
                    alert('No function is defined to handle NMS click');
                },
                onElementClick: function (marker, id) {
                    alert('No function is defined to handle Element click');
                },
                onUpdate: function (changes) {
                    alert("No function is defined for update");
                },
...
function bindHover(marker, map, obj) {
    var content = "<div><table style=\"width:300px;font-size:11px;\"><colgroup><col width=\"45%\"/><col width=\"5%\"/><col/></colgroup><tr><th align=\"left\" colspan=\"3\"><img src=\"images/nms.png\" alt=\"\" title=\"nms\" style=\"width:12px;\"/> Nocout Details<hr/></th></tr><tr><td>Name </td><td>:</td><td>" + obj.name + "</td><tr><tr><td>Total Devices </td><td>:</td><td>" + obj.tH + "</td></tr><tr><td>Enable Devices </td><td>:</td><td>" + obj.eH + "</td></tr><tr><td>Disable Devices </td><td>:</td><td>" + (obj.tH - obj.eH) + "</td></tr></table></div>";
    var info = new google.maps.InfoWindow({
        content: content
    });
