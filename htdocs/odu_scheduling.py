...
class OduScheduling(object):
    ...
    #    		<h2 style=\"text-align:center\">Scheduled Action Status</h2>\
        ...
        html_str += "</select>\
                    ...
                    "<label for=\"radioDown\" style=\"padding-right:6px\" id=\"radioDown_label\">Shutdown</label></input>" \
                    "<input type=\"radio\"  id=\"radioUp\" name=\"radio\" value=\"Up\">" \
                    "<label for=\"radioUp\" style=\"padding-right:6px\" id=\"radioUp_label\">Start</label></input>" \
                    "<input type=\"radio\"  id=\"radioFirmware\" name=\"radio\" value=\"Restart\">" \
                    "<label for=\"radioFirmware\" style=\"padding-right:6px\" id=\"radioFirmware_label\">Restart</label></input>" \
        ...
        html_str += "</select></td>" \
                    ...
                    "</tr>" \
                    "<tr>" \
                    "<td style=\"padding:6px\" >Devices</td>" \
    ...
    def radio_status(result):
        ...
        #     import defaults
        #     f = open(defaults.web_dir + "/htdocs/locale/view_page_tip_scheduling.html", "r")
        #     html_view = f.read()
        #     f.close()
