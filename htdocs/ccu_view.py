...
class CCUForms(object):
    ...
    def battery_panel_form(host_id, selected_device):
        ...
        form_str = "\
        <form id = \"battery_panel_form\" name = \"battery_panel_form\" action=\"battery_panel_action.py\" method =\"get\">\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Battery Capacity</label>\
                ...
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;100 to 1000&nbsp;(Ah)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Solar Panel Capacity</label>\
                ...
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;0 to 999&nbsp;(Wp)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Solar Panel Count</label>\
            ...
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">New battery Installation Date</label>\
    ...
    def status_data_form(host_id, selected_device):
        ...
        # return (status_data_data,host_id)
        device_type = selected_device
        form_str = """\
        <form id = \"status_data_form\" name = \"status_data_form\" action=\"\" method =\"get\">\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Last Reboot Reason </label>\
                <input type = \"text\" maxlength=\"60\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"60\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\"></span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">CCU Up Time </label>\
                <input type = \"text\" maxlength=\"60\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"60\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;(Days:Hours:Mins:Secs)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">AC Meter Reading </label>\
                <input type = \"text\" maxlength=\"15\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;(KWh)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Battery Health </label>\
                <input type = \"text\" maxlength=\"15\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;0 to 100(%%)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Battery Charging/Discharging State </label>\
                <input type = \"text\" maxlength=\"15\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\" />\
                <span style=\"font-size: 9px;\"></span>\
            </div>
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Load Status </label>\
                <input type = \"text\" maxlength=\"15\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\"></span>\
            </div>\
			<div class=\"row-elem\">\
                <label class=\"lbl-large\">AC Availability </label>\
                <input type = \"text\" maxlength=\"15\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\"></span>\
            </div>\
			<div class=\"row-elem\">\
                <label class=\"lbl-large\">External Chargning Status</label>\
                <input type = \"text\" maxlength=\"15\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\"></span>\
            </div>\
			<div class=\"row-elem\">\
                <label class=\"lbl-large\">Battery Charge/Discharge Cycles </label>\
                <input type = \"text\" maxlength=\"15\"  id =\"ccuOAM.ccuStatusDataTable\" name = \"ccuOAM.ccuStatusDataTable\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\"></span>\
            </div>\
            <div class=\"row-elem\">\
                <input type=\"submit\" name =\"ccu_common_submit\" value=\"Save\" id=\"ccu_save\" class=\"yo-small yo-button disabled\" disabled=\"disabled\"/>\
                <input type =\"submit\" name =\"ccu_common_submit\"  id=\"ccu_retry\" value=\"Retry\" style=\"Display:None\" class=\"yo-small yo-button\" />\
                <input type =\"submit\" name =\"ccu_common_submit\" id=\"ccu_cancel\" value=\"Cancel\" style=\"Display:None\"  class=\"yo-small yo-button\" />\
    ...
    def aux_io_form(host_id, selected_device):
        ...
        form_str = "\
        <form id = \"aux_form\" name = \"aux_form\" action=\"aux_action.py\" method =\"get\">\
            <div class=\"row-elem\">\
                <label class=\"lbl\">External Output 1</label>\
                %s\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl\">External Output 2</label>\
                %s\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl\">External Output 3</label>\
                %s\
            </div>\
            <div class=\"row-elem\">\
    ...
    def alarm_threshold_form(host_id, selected_device):
        ...
        form_str = """\
        <form id = \"alarm_threshold_form\" name = \"alarm_threshold_form\" action=\"alarm_threshold_action.py\" method =\"get\">\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">High Temperature Alarm</label>\
                ...
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;0 to 100&nbsp;(C)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\"> PSM Request </label>\
            ...
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">SMPS Max Current Limit</label>\
                <input type = \"text\" maxlength=\"5\"  id =\"ccuOAM.ccuAlarmAndThresholdTable.ccuATSMPSMaxCurrentLimit\" name = \"ccuOAM.ccuAlarmAndThresholdTable.ccuATSMPSMaxCurrentLimit\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;0 to 60000&nbsp;(mA)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Peak Load Current</label>\
                ...
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;0 to 100&nbsp;(mA)</span>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl-large\">Low Voltage Disconnect Level</label>\
                <input type = \"text\" maxlength=\"3\"  id =\"ccuOAM.ccuAlarmAndThresholdTable.ccuATLowVoltageDisconnectLevel\" name = \"ccuOAM.ccuAlarmAndThresholdTable.ccuATLowVoltageDisconnectLevel\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\" />\
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;(mV)</span>\
            </div>
            <div class=\"row-elem\">\
    ...
    def unmp_ip_form(host_id, selected_device):
        ...
        form_str = "\
        <form id = \"unmp_ip_form\" name = \"unmp_ip_form\" action=\"ccu_ip_action.py\" method =\"get\">\
            <div class=\"row-elem\">\
                <label class=\"lbl\">Site Name</label>\
                <input type = \"text\" maxlength=\"64\"  id =\"ccuOAM.ccuSiteInformationTable.ccuSITSiteName\" name = \"ccuOAM.ccuSiteInformationTable.ccuSITSiteName\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <span style=\"font-size: 9px;\">&nbsp;&nbsp;Upto 64 characters allowed</span>\
            </div>\
            <div class=\"row-elem\">\
                <input type=\"submit\" name =\"ccu_common_submit\" value=\"Save\" id=\"ccu_save\" onClick=\"return commonFormSubmit('unmp_ip_form',this)\" class=\"yo-small yo-button disabled\" disabled=\"disabled\" class=\"ui-disabled\" />\
                <input type =\"submit\" name =\"ccu_common_submit\"  id=\"ccu_retry\" value=\"Retry\" style=\"Display:None\" onClick=\"return commonFormSubmit('unmp_ip_form',this)\" class=\"yo-small yo-button\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <input type =\"submit\" name =\"ccu_common_submit\" id=\"ccu_cancel\" value=\"Cancel\" style=\"Display:None\" onClick=\"return commonFormSubmit('unmp_ip_form',this)\" class=\"yo-small yo-button\" disabled=\"disabled\" class=\"ui-disabled\"/>\
    ...
    def peer_form(host_id, selected_device):
        ...
        form_str = "\
        <form id = \"peer_form\" name = \"peer_form\" action=\"peer_action.py\" method =\"get\">\
            <div class=\"row-elem\">\
                <label class=\"lbl\">Peer 1 MAC</label>\
                <input type = \"text\" maxlength=\"18\" id =\"ccuOAM.ccuPeerInformationTable.ccuPIPeer1MACID\" name = \"ccuOAM.ccuPeerInformationTable.ccuPIPeer1MACID\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\" />\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl\">Peer 2 MAC</label>\
                <input type = \"text\" maxlength=\"18\" id =\"ccuOAM.ccuPeerInformationTable.ccuPIPeer2MACID\" name = \"ccuOAM.ccuPeerInformationTable.ccuPIPeer2MACID\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl\">Peer 3 MAC</label>\
                <input type = \"text\" maxlength=\"18\" id =\"ccuOAM.ccuPeerInformationTable.ccuPIPeer3MACID\" name = \"ccuOAM.ccuPeerInformationTable.ccuPIPeer3MACID\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
            </div>\
            <div class=\"row-elem\">\
                <label class=\"lbl\">Peer 4 MAC</label>\
                <input type = \"text\" maxlength=\"18\" id =\"ccuOAM.ccuPeerInformationTable.ccuPIPeer4MACID\" name = \"ccuOAM.ccuPeerInformationTable.ccuPIPeer4MACID\" value = \"%s\" maxsize = \"15\" disabled=\"disabled\" class=\"ui-disabled\"/>\
            </div>\
            <div class=\"row-elem\">\
                <input type=\"submit\" name =\"ccu_common_submit\" value=\"Save\" id=\"ccu_save\" onClick=\"return commonFormSubmit('peer_form',this)\" class=\"yo-small yo-button disabled\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <input type =\"submit\" name =\"ccu_common_submit\"  id=\"ccu_retry\" value=\"Retry\" style=\"Display:None\" onClick=\"return commonFormSubmit('peer_form',this)\" class=\"yo-small yo-button\" disabled=\"disabled\" class=\"ui-disabled\"/>\
                <input type =\"submit\" name =\"ccu_common_submit\" id=\"ccu_cancel\" value=\"Cancel\" style=\"Display:None\" onClick=\"return commonFormSubmit('peer_form',this)\" class=\"yo-small yo-button\" disabled=\"disabled\" class=\"ui-disabled\"/>\
    ...
    def control_form(host_id, selected_device):
        ...
        form_str = "\
        <form id = \"ccu_control\" name = \"ccu_control\" action=\"ccu_control_form.py\" method =\"get\">\
            <div class=\"row-elem\">\
                <label class=\"lbl\">Load Turn Off Time (secs)</label>\
...
class CCUProfiling(object):
        ...
        table_view += "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"display\" id=\"device_data_table\" style=\"text-align:center\">\
                        <thead>\
                            <tr>\
                                ...
                                <th>IP Address</th>\
                                <th>MAC Address</th>\
                                <th>System Voltage (mV)</th>\
                                <th>Solar Current (mA)</th>\
                                <th>Temperature (c)</th>\
                                <th>Actions</th>\
                            </tr>\
                        </thead>\
    ...
    def ccu_profiling_form(host_id, device_type, device_list_parameter):
        ...
        <div class=\"yo-tabs\" id=\"config_tabs\" style=\"display:block\">\
            <ul>\
				<li><a class=\"active\" href=\"#content_1\">Site Info</a></li>\
                <li><a href=\"#content_2\">Battery/Solar Conf</a></li>\
                <li><a href=\"#content_3\">AUX IO</a></li>\
                <li><a href=\"#content_4\">Alarm Threshold</a></li>\
                <li><a href=\"#content_5\">Peer Info</a></li>\
                <li><a href=\"#content_6\">CCU Control</a></li>\
                <li><a href=\"#content_7\">Status Data</a></li>\
            </ul>\
            ...
            <div id=\"content_7\" class=\"tab-content form-div\" style=\"display:block;margin-bottom:0;margin-top:26px\">\
                <div style=\"position: relative;margin-bottom:0px\" class=\"form-div\">\
                %s\
                </div>\
            </div>\
