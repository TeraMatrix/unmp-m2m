...
class Host(object):
    ...
    def header_buttons():
        ...
        @return:
        """
        add_btn = "<div class=\"header-icon\"><img onclick=\"addHost();\" class=\"n-tip-image\" src=\"images/%s/round_plus.png\" id=\"add_host\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Add Device\"></div>" % theme
        edit_btn = "<div class=\"header-icon\"><img onclick=\"editHost();\" class=\"n-tip-image\" src=\"images/%s/doc_edit.png\" id=\"edit_host\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Edit Device Details\"></div>" % theme
        del_btn = "<div class=\"header-icon\"><img onclick=\"delHost();\" class=\"n-tip-image\" src=\"images/%s/round_minus.png\" id=\"del_host\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Delete Device\"></div>" % theme
    ...
    def manage_host():
        ...
        html_view = "" \
                    ...
                    "<ul>" \
                    "<li>" \
                    "<a class=\"active\" href=\"#content_1\" id=\"active_host_tab\">Active Device</a>" \
                    "</li>" \
                    "<li>" \
                    "<a href=\"#content_2\" id=\"disable_host_tab\">Disabled Device</a>" \
                    "</li>" \
                    "<li>" \
                    "<a href=\"#content_3\" id=\"discovered_host_tab\">Discovered Device</a>" \
                    "</li>" \
                    "<li>" \
                    "<a href=\"#content_4\" id=\"deleted_host_tab\">Deleted Device</a>" \
                    "</li>" \
                    "</ul>" \
    ...
    @staticmethod
    def get_service_parameter_html(sp):
        monitor_parameter = "<label class=\"lbl lbl-big\"><input type=\"checkbox\" name=\"service_parameter_" + str(sp["service_parameter_id"]) + "\"/> " + sp["parameter_name"] + "</label>"
        return monitor_parameter
        
    @staticmethod
    def get_service_parameter_details_html():
        service_details = "<div class=\"row-elem\">" \
        "<label class=\"lbl lbl-big\" for=\"service_username\">Username</label>" \
        "<input type=\"text\" id=\"service_username\" name=\"service_username\" title=\"Enter Username to access service api.\" /> " \
        "<label for=\"service_username\" generated=\"true\" class=\"error\"></label>" \
        "</div>" \
        "<div class=\"row-elem\">" \
        "<label class=\"lbl lbl-big\" for=\"service_user_id\">Log ID</label>" \
        "<input type=\"text\" id=\"service_user_id\" name=\"service_user_id\" title=\"Enter User id to access service api.\" /> " \
        "<label for=\"service_user_id\" generated=\"true\" class=\"error\"></label>" \
        "</div>" \
        "<div class=\"row-elem\">" \
        "<label class=\"lbl lbl-big\" for=\"service_password\">Password</label>" \
        "<input type=\"password\" id=\"service_password\" name=\"service_password\" title=\"Enter Password to access service api.\" /> " \
        "<label for=\"service_password\" generated=\"true\" class=\"error\"></label>" \
        "</div>"
    ...
    def create_form(device_type_select_list, host_state_select_list, host_priority_select_list, host_vendor_select_list,
        ...
        monitor_parameter = ""\
        "<table style=\"display:none;\" id=\"monitoringing_parameter\" class=\"tt-table\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" \
        "<tr>" \
        "<th id=\"network_details\" class=\"cell-title\">Monitoring Parameters</th>" \
        "</tr>" \
        "</table>" \
        "<div style=\"display:none;\" class=\"row-elem\" id=\"monitoringing_parameter_div\">" \
        "</div>"\
        "<table style=\"display:none;\" id=\"monitoringing_parameter_details\" class=\"tt-table\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" \
        "<tr>" \
        "<th id=\"network_details\" class=\"cell-title\">Monitoring Service Details</th>" \
        "</tr>" \
        "</table>" \
        "<div style=\"display:none;\" class=\"row-elem\" id=\"monitoringing_parameter_details_div\">" \
        "</div>"
        ...
        html_view = "" \
                    ...
                    "<tr>" \
                    "<th id=\"form_title\" class=\"cell-title\">Add New Device</th>" \
                    "</tr>" \
                    "</table>" \
                    "<div class=\"row-elem\" style=\"display:none;\">" \
                    "<label class=\"lbl lbl-big\" for=\"host_name\">Host Name</label>" \
                    "<input type=\"text\" value=\"host\" id=\"host_name\" name=\"host_name\" readonly=\"readonly\" title=\"Auto generated Device name\" /> " \
                    "<input type=\"hidden\" id=\"host_id\" name=\"host_id\" /> " \
                    "</div>" \
                    "<div class=\"row-elem\">" \
                    "<label class=\"lbl lbl-big\" for=\"host_alias\">Device Alias</label>" \
                    ...
                    "</div>" \
                    "<div class=\"row-elem\">" \
                    "<label class=\"lbl lbl-big\" for=\"phone_no\">Phone No</label>" \
                    "<input type=\"text\" id=\"phone_no\" name=\"phone_no\" title=\"Enter Phone No. e.g. 9828098280\" /> " \
                    ...
                    "" + device_type_select_list + "" \
                                                   ...
                                                   "<input type=\"text\" id=\"mac_address\" name=\"mac_address\" title=\"Enter the Device MAC Address or Hardware Address.\" /> " \
                                                   ...
                                                   "<input type=\"text\" id=\"ra_mac\" name=\"ra_mac\" title=\"Enter or Fetch Device Radio Access MAC Address.\"/>" \
                                                   ...
                                                   "" + master_select_list + "" \
                                                                             ...
                                                                             "</div>" \
                                                                             "<div class=\"row-elem\">" \
                                                                             "<label class=\"lbl lbl-big\" for=\"host_state\">Device State</label>" \
                                                                             "" + host_state_select_list + "" \
                                                                                                           ...
                                                                                                           "" + host_priority_select_list + "" \
                                                                                                                                            "</div>" \
                                                                                                                                            "<div class=\"row-elem\">" \
                                                                                                                                            "<label class=\"lbl lbl-big\" for=\"host_parent\">Device Parent</label>" \
                                                                                                                                            "" + host_parent_select_list + "" \
                                                                                                                                                                           "</div>" \
                                                                                                                                                                           "<div class=\"row-elem\">" \
                                                                                                                                                                           "<label class=\"lbl lbl-big\" for=\"hostgroup\">Device group</label>" \
                                                                                                                                                                           "" + host_hostgroups_select_list + "" \
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              "<textarea id=\"host_comment\" name=\"host_comment\" title=\"Enter Device Comment\"></textarea>" \
                                                                                                                                                                                                              "</div>" \
                                                                                                                                                                                                              "" + monitor_parameter + "" \
                                                                                                                                                                                                              "<div  id=\"device_details_div\" style='display:none;'>" \
                                                                                                                                                                                                              "<table class=\"tt-table\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" \
                                                                                                                                                                                                              "<tr>" \
                                                                                                                                                                                                              "<th id=\"network_details\" class=\"cell-title\">Device Details</th>" \
                                                                                                                                                                                                              "</tr>" \
                                                                                                                                                                                                              "</table>" \
                                                                                                                                                                                                              "<div class=\"row-elem\">" \
                                                                                                                                                                                                              "<label class=\"lbl lbl-big\" for=\"device_path\">Device Path</label>" \
                                                                                                                                                                                                              "<input type=\"text\" id=\"device_path\" name=\"device_path\" title=\"Enter Device Path\" /> " \
                                                                                                                                                                                                              "</div>" \
                                                                                                                                                                                                              "<div class=\"row-elem\">" \
                                                                                                                                                                                                              "<label class=\"lbl lbl-big\" for=\"number_of_ports\">Number of Ports</label>" \
                                                                                                                                                                                                              "<input type=\"text\" id=\"number_of_ports\" name=\"number_of_ports\" title=\"Enter Number of Ports Address\" /> " \
                                                                                                                                                                                                              "</div>" \
                                                                                                                                                                                                              "</div>" \
                                                                                                                                                                                                              "<table class=\"tt-table\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" \
                                                                                                                                                                                                              "<tr>" \
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              "" + dns_state_select_list + "" \
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           "" + snmp_version_select_list + "" \
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           "<table class=\"tt-table\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" \
                                                                                                                                                                                                                                                                           "<tr>" \
                                                                                                                                                                                                                                                                           "<th id=\"snmp_details\" class=\"cell-title\">Device Asset</th>" \
                                                                                                                                                                                                                                                                           "</tr>" \
                                                                                                                                                                                                                                                                           "</table>" \
                                                                                                                                                                                                                                                                           "<div class=\"row-elem\" style=\"display:none;\">" \
                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                           "" + host_vendor_select_list + "" \
                                                                                                                                                                                                                                                                                                          "</div>" \
                                                                                                                                                                                                                                                                                                          "<div class=\"row-elem\" style=\"display:none;\">" \
                                                                                                                                                                                                                                                                                                          "<label class=\"lbl lbl-big\" for=\"host_os\">Device OS</label>" \
                                                                                                                                                                                                                                                                                                          "" + host_os_select_list + "" \
                                                                                                                                                                                                                                                                                                                                     "</div>" \
                                                                                                                                                                                                                                                                                                                                     "<div class=\"row-elem\">" \
                                                                                                                                                                                                                                                                                                                                     "<label class=\"lbl lbl-big\" for=\"longitude\">Longitude</label>" \
                                                                                                                                                                                                                                                                                                                                     "<input type=\"text\" id=\"longitude\" name=\"longitude\" title=\"Enter Device Longitude\" value=\"\" />" \
                                                                                                                                                                                                                                                                                                                                     "</div>" \
                                                                                                                                                                                                                                                                                                                                     "<div class=\"row-elem\">" \
                                                                                                                                                                                                                                                                                                                                     "<label class=\"lbl lbl-big\" for=\"latitude\">Latitude</label>" \
                                                                                                                                                                                                                                                                                                                                     "<input type=\"text\" id=\"latitude\" name=\"latitude\" title=\"Enter Device Latitude\" value=\"\" />" \
                                                                                                                                                                                                                                                                                                                                     "</div>" \
                                                                                                                                                                                                                                                                                                                                     "<div class=\"row-elem\" style=\"display:none;\">" \
                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                     "<input type=\"text\" id=\"serial_number\" name=\"serial_number\" title=\"Enter Device Serial Number\" />" \
                                                                                                                                                                                                                                                                                                                                     "</div>" \
                                                                                                                                                                                                                                                                                                                                     "<div class=\"row-elem hardware\">" \
                                                                                                                                                                                                                                                                                                                                     "<label class=\"lbl lbl-big\" for=\"hardware_version\">Hardware Version</label>" \
                                                                                                                                                                                                                                                                                                                                     "<input type=\"text\" id=\"hardware_version\" name=\"hardware_version\" title=\"Enter Device Hardware Version\"/>" \
                                                                                                                                                                                                                                                                                                                                     "</div>" \
                                                                                                                                                                                                                                                                                                                                     "</div>" \
...
class Hostgroup(object):
    ...
    def header_buttons():
        ...
        @return:
        """
        add_btn = "<div class=\"header-icon\"><img onclick=\"addHostgroup();\" class=\"n-tip-image\" src=\"images/%s/round_plus.png\" id=\"add_hostgroup\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Add Device group\"></div>" % theme
        edit_btn = "<div class=\"header-icon\"><img onclick=\"editHostgroup();\" class=\"n-tip-image\" src=\"images/%s/doc_edit.png\" id=\"edit_hostgroup\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Edit Device group\"></div>" % theme
        del_btn = "<div class=\"header-icon\"><img onclick=\"delHostgroup();\" class=\"n-tip-image\" src=\"images/%s/round_minus.png\" id=\"del_hostgroup\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Delete Device group\"></div>" % theme
        header_btn = del_btn + add_btn
        return header_btn
    ...
    def create_form():
        ...
        html_view = "" \
                    ...
                    "<table class=\"tt-table\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" \
                    "<tr>" \
                    "<th id=\"form_title\" class=\"cell-title\">Add New Device group</th>" \
                    "</tr>" \
                    "</table>" \
                    "<div class=\"row-elem\">" \
                    "<label class=\"lbl lbl-big\" for=\"hostgroup_name\">Device group Name</label>" \
                    "<input type=\"text\" id=\"hostgroup_name\" name=\"hostgroup_name\" title=\"Enter Device group Name\" /> " \
                    "<input type=\"hidden\" id=\"hostgroup_id\" name=\"hostgroup_id\" /> " \
                    "</div>" \
                    "<div class=\"row-elem\">" \
                    "<label class=\"lbl lbl-big\" for=\"hostgroup_alias\">Device group Alias</label>" \
                    "<input type=\"text\" id=\"hostgroup_alias\" name=\"hostgroup_alias\" title=\"Enter Device group Alias\" /> " \
                    "</div>" \
                    "</div>" \
                    "<div class=\"form-div-footer\">" \
...
class Discovery(object):
    ...
    def header_buttons():
        ...
        @return:
        """
        add_btn = "<div class=\"header-icon\"><img onclick=\"addHost();\" class=\"n-tip-image\" src=\"images/%s/round_plus.png\" id=\"add_host\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Add Discovered Device\"></div>" % theme
        del_btn = "<div class=\"header-icon\"><img onclick=\"delHost();\" class=\"n-tip-image\" src=\"images/%s/round_minus.png\" id=\"del_host\" style=\"width: 16px; height: 16px; margin: 6px 20px 6px 10px;\" original-title=\"Delete Discovered Device\"></div>" % theme
        header_btn = del_btn + add_btn
        return header_btn
    ...
    def discovery():
        ...
        html_view = "" \
                    ...
                    "<ul>" \
                    "<li>" \
                    "<a class=\"active\" href=\"#content_1\" id=\"discovered_host_tab\">Discovered Device</a>" \
                    "</li>" \
                    "<li>" \
...
class HostUtils(object):
    '''
    Update service details form
    '''
    @staticmethod
    def update_form_host_service_parameter(parameter_id, min_value="", max_value="", min_arm="", max_arm="", parameter_type=""):
        html = "<div id='help_container'><h1>Update Service Thresholds</h1></div>"
        if not parameter_id:
            html += "<p>Server is busy, Please try again later.</p>"
        else:
            html += "<form id='update_service'>\
            <div class='row-elem'>\
            <input type='hidden' name='parameter_id' value='%s' /> \
            <label class='lbl lbl-big' style='width:100px;'>Min Threshold</label>\
            <input type='text' name='min_value' value='%s' /> \
            </div>\
            <div class='row-elem'>\
            <label class='lbl lbl-big' style='width:100px;'>Action</label>\
            %s\
            </div>\
            <div class='row-elem'>\
            <label class='lbl lbl-big' style='width:100px;'>Max Threshold</label>\
            <input type='text' name='max_value' value='%s' /> \
            </div>\
            <div class='row-elem'>\
            <label class='lbl lbl-big' style='width:100px;'>Action</label>\
            %s\
            ...
            <div class='row-elem'>\
            <input type='hidden' name='parameter_type' value='%s' /> \
            <input type='submit' class='yo-button' value='Submit' />\
            <div>\
            </form>" % (parameter_id, min_value, HostUtils.arm_service_select_box(min_arm, "min_arm"), max_value, HostUtils.arm_service_select_box(max_arm, "max_arm"), parameter_type)
        return html
    
    @staticmethod
    def arm_service_select_box(arm, name="arm"):
        data = (
            ("", "Disabled"),
            ("1", "Relay 1"),
            ("2", "Relay 2"),
        ...
        for k,v in data:
            if k == arm:
                html += "<option value='%s' selected='selected'>%s</option>" % (k,v)
            else:
                html += "<option value='%s'>%s</option>" % (k,v)
        html += "</select>"
        return html
